...
const ExperienceCard = ({ experience }) => {
  ...
  function onDocumentLoadSuccess({ numPages }) {
    console.log(
      '🚀 ~ file: Experience.jsx:30 ~ onDocumentLoadSuccess ~ numPages:',
      numPages
    );
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} text-center`}>Milestones</p>
        <h2 className={`${styles.sectionHeadText} text-center`}>
          ElectraMech Timeline in Brief.
        </h2>
      </motion.div>
    </>
  );
...
export default SectionWrapper(ExperienceHeader, 'work');
